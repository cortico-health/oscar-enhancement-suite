          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                ...
                if (token) {
                  sendMessage(data, token).then(handleErrors).then(function (response) {
                    setMessageInfo({
                      title: "Success",
