...
/* harmony import */ var _resources_icons_96x96_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../resources/icons/96x96.png */ "./resources/icons/96x96.png");
...
function Messenger() {
  ...
  function Header() {
    return h("div", {
      ...
      src: _resources_icons_96x96_png__WEBPACK_IMPORTED_MODULE_1__.default,
      alt: "Cortico"
    }), h("p", {
  ...
  function Subject() {
    return h("div", {
      ...
      type: "text",
      class: " tw-mt-0 tw-block tw-w-full tw-px-2 tw-py-2 tw-border-0 tw-border-b tw-border-gray-200 tw-tracking-wider tw-focus:ring-0 tw-focus:border-black tw-text-sm tw-text-gray-700 ",
      placeholder: "Subject"
    })));
  }
  ...
  function Chat() {
    return h("div", {
      ...
      class: " tw-form-textarea form-textarea tw-block tw-w-full tw-rounded-md tw-border-gray-200 tw-shadow-sm tw-focus:border-indigo-300  tw-focus:ring  tw-focus:ring-indigo-200  tw-focus:ring-opacity-50  tw-resize-none tw-text-sm tw-text-gray-600 tw-p-2 ",
      rows: "8",
  ...
  function Content() {
    return h("div", {
      ...
      className: "tw-fixed tw-bottom-5 tw-left-5 tw-bg-white tw-z-50 tw-max-w-[400px] tw-shadow-xl tw-w-full tw-rounded-md "
    }, h(Header, null), h("div", {
      className: "tw-px-4 tw-py-2"
    }, h(To, null)), h("hr", {
      className: "tw-opacity-10"
    }), h("div", {
      className: "tw-p-4 tw-w-full"
    }, h(Subject, null)), h("div", {
      className: "tw-px-4"
    }, h(Chat, null)), h("div", {
      className: "tw-flex tw-justify-end tw-p-4"
    }, h("button", {
      className: "tw-bg-cortico-blue tw-px-3 tw-py-2 tw-rounded-lg tw-text-white tw-text-sm tw-flex tw-items-center"
