...
var _excluded = ["onSubmit", "close", "patient", "loading", "showSavedReplies", "defaultSubject", "defaultBody"];
...
var _excluded = ["add", "cancel"],
    _excluded2 = ["uuid", "subject", "body", "onClick", "onDelete"],
    _excluded3 = ["uuid", "onDeleted", "onCancel"],
    _excluded4 = ["loadReply"];
...
function AddReply(_ref) {
  ...
  return h("div", null, h("div", {
    ...
    className: "tw-mr-2"
  }, "Save Reply"), h(_Icons_HeroIcons__WEBPACK_IMPORTED_MODULE_6__.PlusIcon, {
    className: "tw-h-4 tw-w-4 tw-text-white"
  })))));
}
...
function DeleteReply(_ref3) {
  var uuid = _ref3.uuid,
      onDeleted = _ref3.onDeleted,
  ...
  var deleteReply = function deleteReply() {
    ...
    if (savedReplies) {
      ...
      if (reply) {
        savedReplies = temp.filter(function (r) {
          return r.uuid !== uuid;
        });
  ...
  return h("div", {
    className: "tw-font-sans tw-p-6 tw-bg-white"
  }, h("h2", {
    className: "tw-tracking-wider tw-text-xl text-center"
  }, "Are you sure you want to delete?"), h("div", {
    className: "tw-mt-5"
  }, h("button", {
    className: "tw-gray-200 tw-text-sm tw-p-4 tw-text-white"
  }, "No"), h("button", {
    onClick: deleteReply,
...
function SavedReplies(_ref4) {
  var loadReply = _ref4.loadReply,
  ...
  var _useState = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_4__.useState)(false),
      ...
      addReply = _useState2[0],
      setAddReply = _useState2[1];
  ...
  var _useState5 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_4__.useState)(0),
      _useState6 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_useState5, 2),
      insertCounter = _useState6[0],
      setInsertCounter = _useState6[1];

  var _useState7 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_4__.useState)(false),
      _useState8 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_useState7, 2),
      deleteReply = _useState8[0],
      setDeleteReply = _useState8[1];

  var _useState9 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_4__.useState)(null),
      _useState10 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_useState9, 2),
      deleteCandidate = _useState10[0],
      setDeleteCandidate = _useState10[1];
  ...
  var handleDelete = function handleDelete(uuid) {
    setDeleteReply(true);
  ...
  return h("div", {
  ...
  }, "Save or load new replies to your message"))), h("div", {
    ...
    add: handleAdd,
    cancel: handleCancel
  }), deleteReply === true ? h(DeleteReply, {
    uuid: deleteCandidate,
    onCancel: function onCancel() {
      setDeleteReply(false);
      setDeleteCandidate(null);
    },
    onDeleted: function onDeleted(replies) {
      setReplies(replies);
      setInsertCounter(insertCounter + 1);
      setDeleteReply(false);
      setDeleteCandidate(null);
    ...
    className: "tw-mr-2"
  }, "New Reply"), h(_Icons_HeroIcons__WEBPACK_IMPORTED_MODULE_6__.PlusIcon, {
    className: "tw-h-4 tw-w-4 tw-text-white"
  }))))) : "");
}
