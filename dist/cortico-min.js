...
var _excluded = ["add", "cancel"],
    _excluded2 = ["subject", "body", "onClick"],
...
function SavedReplies(_ref3) {
  ...
  return h("div", {
    ...
    className: "tw-bg-gray-100 tw-overflow-y-auto tw-h-[300px] ".concat(addReply ? "tw-p-0" : "tw-p-4")
