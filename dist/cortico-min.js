...
function Messenger() {
  ...
  function Header() {
    return h("div", {
      className: "tw-flex tw-px-3 tw-py-2 tw-rounded-t-md tw-justify-between tw-items-center tw-bg-gray-100 tw-border"
    }, h("h2", null, "Messenger"), h("div", null, "Close"));
  }
  ...
  function Subject() {
    return h("div", {
      ...
      type: "text",
      className: " tw-form-input form-input   tw-block tw-w-full tw-border-b tw-rounded-md tw-border-black tw-focus:border-indigo-300  tw-focus:ring  tw-focus:ring-indigo-200  tw-focus:ring-opacity-50 tw-border-opacity-10 ",
  ...
  function Chat() {
    return h("div", {
      ...
      class: " tw-form-textarea form-textarea tw-block tw-w-full tw-rounded-md tw-border-gray-300 tw-shadow-sm tw-focus:border-indigo-300  tw-focus:ring  tw-focus:ring-indigo-200  tw-focus:ring-opacity-50  tw-resize-none ",
      rows: "8",
  ...
  function Content() {
    return h("div", {
      ...
      className: "tw-fixed tw-bottom-5 tw-left-5 tw-bg-white tw-z-50 tw-max-w-screen-messenger tw-shadow-md tw-w-full tw-rounded-md"
    }, h(Header, null), h("div", {
      className: "tw-p-4 tw-w-full"
    }, h(Subject, null)), h("div", {
      className: "tw-p-4 tw-border-t tw-border-black tw-border-opacity-10"
    }, h(Chat, null)), h("div", {
      className: "tw-flex tw-justify-end tw-p-4"
    }, h("button", {
      className: "tw-bg-cortico-blue tw-px-3 tw-py-3 tw-rounded-md tw-text-white"
    }, "Send Message"))));
  }
