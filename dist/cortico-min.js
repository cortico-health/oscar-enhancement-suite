...
function appointmentMenu(apptTd, apptInfo, checkCache, pharmaciesCache) {
  ...
  if (isPharmacyCached) {
    apptTd.querySelector('[title="Prescriptions"]').appendChild((0,_Utils_Utils__WEBPACK_IMPORTED_MODULE_7__.create)("<small>&#10004;</small>"));
  }
...
function getAppointmentInfo(apptNodes) {
  ...
  apptNodes.forEach(function (node) {
    var temp = {};
    var apptLink = getAppointmentLink(node); // No Appointment link
    ...
    var apptUrl = extractApptUrl(apptLink.attributes.onclick.textContent);
    var demographicNo = (0,_Utils_Utils__WEBPACK_IMPORTED_MODULE_0__.getDemographicNo)(apptUrl);
...
/* harmony import */ var _modules_cortico_Login_Login__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/cortico/Login/Login */ "./modules/cortico/Login/Login.js");
...
/* harmony import */ var _modules_cortico_Dashboard__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/cortico/Dashboard */ "./modules/cortico/Dashboard/index.js");
...
var init_cortico = function init_cortico() {
  ...
  */
  ...
  if (route.indexOf("/appointment/addappointment.jsp") > -1 || route.indexOf("/appointment/appointmentcontrol.jsp") > -1) {
    ...
    (0,_modules_cortico_Login_Login__WEBPACK_IMPORTED_MODULE_8__.addLoginForm)(chrome);
...
function init_appointment_page() {
  ...
  last_button.parentNode.appendChild((0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_11__.htmlToElement)("<button class='cortico-btn' type='button' id='cortico-video-appt-btn'>Video Call &phone;</button>"));
  update_video_button();
}
...
function _demoFromHTML() {
  _demoFromHTML = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee4() {
    var pdf;
...
function _setupPatientEmailButton() {
  _setupPatientEmailButton = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee6() {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 6:
            ...
            email_btn = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_11__.htmlToElement)("\n  <p style='margin-bottom:2em'>\n    <a id='cortico-email-patient' class='cortico-btn'>Email Patient</a>\n  </p>\n  ");
            delegate(email_btn, 'click', 'a', /*#__PURE__*/function () {
              var _ref3 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee5(e) {
...
function _createSideBar() {
  _createSideBar = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee7() {
...
function _addMenu() {
  _addMenu = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee8(container) {
...
function getRecallStatusOption() {
  ...
  var button = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_11__.htmlToElement)("<button class='cortico-btn'>Save</button>"); // document.createElement("button");
...
function _getCorticoLogin() {
  _getCorticoLogin = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee9() {
...
function dragAndDrop() {
  ...
  function _drop_handler() {
    _drop_handler = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee2(ev) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              apptLink = (0,_modules_cortico_Appointments_Appointments__WEBPACK_IMPORTED_MODULE_6__.getAppointmentLink)(dragSelectedTarget);
            ...
            case 8:
              ...
              apptUrl = (0,_modules_cortico_Appointments_Appointments__WEBPACK_IMPORTED_MODULE_6__.extractApptUrl)(apptLinkText); //Get our base url with the provider
...
function _checkAllEligibility() {
  _checkAllEligibility = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee10() {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 2:
            ...
            appointmentInfo = (0,_modules_cortico_Appointments_Appointments__WEBPACK_IMPORTED_MODULE_6__.getAppointmentInfo)(nodes);
          ...
          case 41:
            ...
            error = true;
            return _context10.abrupt("break", 54);
    ...
    }, _callee10, null, [[12, 56, 60, 64], [21, 27]]);
  }));
  return _checkAllEligibility.apply(this, arguments);
}
...
function checkEligiblity(demographicNo, origin, namespace, providerNo) {
  var url = origin + "/" + namespace + "/" + "billing/CA/BC/ManageTeleplan.do?demographic=" + demographicNo + "&method=checkElig";
...
function plusSignAppointments(demographic_no) {
  ...
  appointments.map(function (appt) {
    var apptLink = (0,_modules_cortico_Appointments_Appointments__WEBPACK_IMPORTED_MODULE_6__.getAppointmentLink)(appt);
...
function _setupPreferredPharmacy() {
  _setupPreferredPharmacy = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee11(code, demographic_no) {
...
function storePharmaciesCache(demographicNo) {
  ...
  var date = dayjs__WEBPACK_IMPORTED_MODULE_5___default()().format("YYYY-MM-DD"); // this should be done when we access. not write.
...
function _getDiagnosticFromCortico() {
  _getDiagnosticFromCortico = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee12(appt_no, notes, token) {
    var clinicName, url;
...
function _setupPreferredPharmacies() {
  _setupPreferredPharmacies = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee13() {
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 14:
            demographicNo = null;
            _context13.prev = 15;
            apptUrl = (0,_modules_cortico_Appointments_Appointments__WEBPACK_IMPORTED_MODULE_6__.extractApptUrl)(element.attributes.onclick.textContent);
            ...
            if (!(demographics && Array.isArray(demographics) && demographics.includes(demographicNo) && pharmaciesCache.date == dayjs__WEBPACK_IMPORTED_MODULE_5___default()().format("YYYY-MM-DD"))) {
              _context13.next = 24;
              break;
            }
...
function _init_diagnostic_viewer_button() {
  _init_diagnostic_viewer_button = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee16() {
        ...
        switch (_context16.prev = _context16.next) {
          case 0:
            _open_diagnostic_viewer = function _open_diagnostic_view2() {
              _open_diagnostic_viewer = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee15(e) {
                var appt_no;
                  ...
                  while (1) {
                    switch (_context15.prev = _context15.next) {
                      case 0:
                        ...
                        (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_11__.loadExtensionStorageValue)("jwt_access_token").then( /*#__PURE__*/function () {
                          var _ref4 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee14(access_token) {
            ...
            open_diagnostic_viewer = function _open_diagnostic_view(_x11) {
              return _open_diagnostic_viewer.apply(this, arguments);
            };
            ...
            last_button.parentNode.appendChild((0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_11__.htmlToElement)("<button class='cortico-btn' id='diagnostic-viewer-btn'>Patient Responses</button>"));
...
function _init_recall_button() {
  _init_recall_button = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee18() {
        ...
        switch (_context18.prev = _context18.next) {
          case 0:
            _send_patient_recall_email = function _send_patient_recall_2() {
              _send_patient_recall_email = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee17(e) {
            ...
            send_patient_recall_email = function _send_patient_recall_(_x13) {
              return _send_patient_recall_email.apply(this, arguments);
            };
...
function _getPatientInfo() {
  _getPatientInfo = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee19() {
      ...
      while (1) {
        switch (_context19.prev = _context19.next) {
          ...
          case 5:
            ...
            if (emails.length) info.email = emails[0]; // Should return 2 from view and edit, get atleast one
...
function getDemographicPageResponse() {
  ...
  var demographicNo = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_11__.getDemographicNo)(window.location.search) || (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_11__.getDemographicNo)(window.opener.location.search);
