...
/* harmony import */ var _modules_Icons_CorticoIcon__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/Icons/CorticoIcon */ "./modules/Icons/CorticoIcon.js");
/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index.css */ "./index.css");
/* harmony import */ var _modules_Modal_Modal__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/Modal/Modal */ "./modules/Modal/Modal.js");
/* harmony import */ var _modules_cortico_Dashboard__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/cortico/Dashboard */ "./modules/cortico/Dashboard/index.js");
/* harmony import */ var _modules_cortico_Disclaimer__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/cortico/Disclaimer */ "./modules/cortico/Disclaimer.js");
...
var init_schedule = function init_schedule() {
  if (!(oscar.isOscarGoHost() || oscar.isKaiOscarHost() || oscar.containsKaiBar() || oscar.containsOscarGoOceanScript())) {
    var debounced = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.debounce)(oscar.updateDoctorHeadings.bind(oscar), 50);
...
function init_appointment_page() {
  ...
  last_button.parentNode.appendChild((0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.htmlToElement)("<button class='cortico-btn' type='button' id='cortico-video-appt-btn'>Video Call &phone;</button>"));
  update_video_button();
}
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 6:
            ...
            email_btn = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.htmlToElement)("\n  <p style='margin-bottom:2em'>\n    <a id='cortico-email-patient' class='cortico-btn'>Email Patient</a>\n  </p>\n  ");
...
function addCorticoLogo() {
  ...
  var listitem = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.create)("\n    <li>\n      <a href=\"https://cortico.health\"></a>\n    </li>\n  ");
  var corticoLogo = (0,_modules_Icons_CorticoIcon__WEBPACK_IMPORTED_MODULE_11__.CorticoIcon)({
    attrs: {
      height: "15",
...
function addMenu(container) {
  ...
  menu.addEventListener("click", function () {
    ...
    if (!opened) {
      var modal = new _modules_Modal_Modal__WEBPACK_IMPORTED_MODULE_13__.Modal();
      modal.setContent((0,_modules_cortico_Disclaimer__WEBPACK_IMPORTED_MODULE_15__.default)());
      modal.show();
...
function getRecallStatusOption() {
  ...
  var button = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.htmlToElement)("<button class='cortico-btn'>Save</button>"); // document.createElement("button");
...
function getCorticoUrlOption() {
  ...
  if (window.localStorage["firstRun"] !== "false") {
    var instructions = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.create)("div", {
      attrs: {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              namespace = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getNamespace)();
              _context2.next = 14;
...
function _checkAllEligibility() {
  _checkAllEligibility = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee7() {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            return _context7.abrupt("return", alert("Check Already Running"));
          ...
          case 14:
            ...
            _context7.prev = 21;
            _context7.next = 24;
            return checkEligiblity(demographic_no, (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getOrigin)(), (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getNamespace)(), providerNo);
    ...
    }, _callee7, null, [[12, 56, 60, 64], [21, 27]]);
  }));
  return _checkAllEligibility.apply(this, arguments);
}
...
function getPharmacyResults(searchTerm) {
  ...
  var url = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getOrigin)() + "/" + (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getNamespace)() + "/" + newLocal;
  return fetch(url, {
    method: "GET",
...
function setPreferredPharmacy(pharmacyObj, demographicNo) {
  var url = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getOrigin)() + "/" + (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getNamespace)() + "/" + "oscarRx/managePharmacy.do?method=setPreferred";
...
function _setupPreferredPharmacy() {
  _setupPreferredPharmacy = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee8(code, demographic_no) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 4:
            corticoPharmacy = _context8.sent;
            _context8.t0 = JSON;
            _context8.next = 8;
          ...
          case 8:
            ...
            corticoPharmacyText = _context8.t0.parse.call(_context8.t0, _context8.t1);
          ...
          case 18:
            currPharmacyResults = _context8.sent;
            _context8.t2 = JSON;
            _context8.next = 22;
          ...
          case 22:
            ...
            currPharmacyText = _context8.t2.parse.call(_context8.t2, _context8.t3);
          ...
          case 45:
            setPharmacyResults = _context8.sent;
            _context8.next = 48;
            return setPharmacyResults.text();

          case 48:
            setPharmacyText = _context8.sent;
...
function displayPharmaciesFailure(demograhicNo, msg) {
  ...
  sidebar_panel.appendChild((0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.htmlToElement)("<div>demo#" + demograhicNo + " : " + msg));
}
...
function _getDiagnosticFromCortico() {
  _getDiagnosticFromCortico = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee9(appt_no, notes) {
    var clinicName, url;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            return _context9.abrupt("return", fetch(url, {
              method: "GET",
              headers: {
                "Content-Type": "application/json"
              }
...
function _setupPreferredPharmacies() {
  _setupPreferredPharmacies = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee10() {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 14:
            ...
            demographicNo = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getDemographicNo)(apptUrl);
          ...
          case 34:
            ...
            storePharmaciesFailureCache(demographicNo, _context10.t0.message);
            displayPharmaciesFailure(demographicNo, _context10.t0.message);
...
function _init_diagnostic_viewer_button() {
  _init_diagnostic_viewer_button = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee12() {
        ...
        switch (_context12.prev = _context12.next) {
          case 0:
            _open_diagnostic_viewer = function _open_diagnostic_view2() {
              _open_diagnostic_viewer = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee11(e) {
                ...
                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee11$(_context11) {
                  while (1) {
                    switch (_context11.prev = _context11.next) {
                      ...
                      case 4:
                        diagnostic_response = _context11.sent;
                        _context11.t0 = String;
                        _context11.next = 8;
                        return diagnostic_response.text();

                      case 8:
                        _context11.t1 = _context11.sent;
                        diagnostic_text = (0, _context11.t0)(_context11.t1);
                        _context11.next = 12;
            ...
            open_diagnostic_viewer = function _open_diagnostic_view(_x9) {
              return _open_diagnostic_viewer.apply(this, arguments);
            };
            ...
            last_button.parentNode.appendChild((0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.htmlToElement)("<button class='cortico-btn' id='diagnostic-viewer-btn'>Patient Responses</button>"));
...
function _init_recall_button() {
  _init_recall_button = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee14() {
        ...
        switch (_context14.prev = _context14.next) {
          case 0:
            _send_patient_recall_email = function _send_patient_recall_2() {
              _send_patient_recall_email = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee13(e) {
            ...
            send_patient_recall_email = function _send_patient_recall_(_x10) {
              return _send_patient_recall_email.apply(this, arguments);
            };
            ...
            statusValue = statusOption.options[statusOption.selectedIndex].text;
            last_button = document.querySelector("#cortico-video-appt-btn").parentNode;
            last_button.parentNode.appendChild((0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.htmlToElement)("<button class='cortico-btn' type='button' id='recall-btn'>Recall email</button>"));
...
function _getPatientInfo() {
  _getPatientInfo = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee15() {
...
function getDemographicPageResponse() {
  ...
  var namespace = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getNamespace)();
  var demographicNo = (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getDemographicNo)(window.location.search) || (0,_modules_Utils_Utils__WEBPACK_IMPORTED_MODULE_10__.getDemographicNo)(window.opener.location.search);
