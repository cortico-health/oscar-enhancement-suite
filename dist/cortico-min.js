...
function Reply(_ref) {
  ...
  return h("div", {
    className: "tw-bg-white tw-rounded-lg tw-py-4 tw-cursor-pointer tw-hover:bg-gray-200 tw-h-28 "
  }, h("div", {
    className: "tw-px-4 tw-mb-2 tw-text-opacity-100 tw-text-black"
  }, subject), h("div", {
    className: "tw-px-4 tw-text-sm tw-text-opacity-80 tw-text-black tw-line-clamp-3"
  }, body));
}

function SavedReplies() {
  return h("div", {
    className: "tw-bg-white tw-rounded-lg tw-font-sans tw-min-w-[400px] tw-shadow-lg tw-max-w-[500px]"
  }, h("div", {
    ...
    className: "tw-bg-gray-200 tw-p-4 tw-rounded-b-lg"
  }, h(Reply, {
