      ...
      <div
        ...
        <div
          ...
          <div className="tw-max-w-full tw-ml-4 tw-cursor-pointer">
            <p
              className={`tw-text-contact2 tw-w-72 tw-cursor-pointer tw-whitespace-nowrap tw-text-ellipsis tw-overflow-hidden ${
                isSelected
            ...
            <p
              className={`tw-text-contact3 tw-relative tw-cursor-pointer tw-mt-2 tw-w-72 tw-whitespace-nowrap tw-text-ellipsis tw-overflow-hidden ${
                isSelected
                  ? "tw-text-white tw-font-bold"
