          ...
          <>
            <div className="flex mb-5 gap-x-5 justify-between">
              {patient.image ? (
                ...
                <ASvg
                  className="h-12.5 min-w-12.5 border-2 rounded-full p-0.25 border-primary-500"
                  src="avatar"
                />
              )}
              <div>
                <h1 className="text-h1 text-secondary-500 font-medium">
                  {patient.first_name + " " + patient.last_name}
                </h1>
                <h2 className="text-h2 text-secondary-500 mb-2.5">
                  {patient.facility}
                </h2>
            ...
            <AButton
              ...
              {" "}
              <ASvg src="switch" /> Switch patient
            </AButton>
          </>
        ) : (
          <>
            <h1 className="text-h1 text-secondary-500 font-medium mb-1.5">
              Viewing all conversations
            </h1>
            <p className="text-h3 text-secondary-300 mb-5">
              No patient selected
            </p>
            <AButton
              href="/select"
