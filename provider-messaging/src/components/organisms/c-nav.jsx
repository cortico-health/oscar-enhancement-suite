...
const CNav = () => {
  ...
  return (
    <>
      ...
      <div className='c-nav__mobile flex sticky z-20 lg:hidden top-0 min-h-22 w-full'>
        ...
        {patient ?
          <div className='bg-secondary-20 -ml-4 pl-16 w-full flex flex-col justify-center'>
