      ...
      <>
        <nav className="c-nav shadow fixed pt-6 pb-3 z-10 lg:flex hidden flex-col justify-between bg-white left-0 h-screen w-20">
          ...
          <div className="flex flex-col">
            <MNavItem
              name="Home"
              activeClassName="bg-primary-500 child:child:stroke-white"
              icon="grid"
              href="/"
            />
            <MNavItem
              ...
              className={`mx-auto p-3 rounded-full ${
                ...
                "bg-primary-500 child:child:stroke-white"
              }`}
              icon="selected"
              href="/chat"
              svgClass="stroke-secondary-500"
            />
            <MNavItem
              name="Profile"
              activeClassName="bg-primary-500 child:child:stroke-white"
          ...
          <div className="flex flex-col">
            ...
            <div
              ...
              className="mx-auto p-3 cursor-pointer rounded-full">
              {" "}
              <ASvg src="log-out" />
            </div>
        ...
        <div className="c-nav__mobile flex sticky z-20 lg:hidden top-0 min-h-22 w-full bg-secondary-20">
          <div className="z-10 flex w-full px-7 gap-x-7 bg-primary-500 rounded-tr-2xl rounded-br-2xl items-center">
            <div onClick={() => setIsOpened(true)}>
              <ASvg className="cursor-pointer" src="menu" />{" "}
            </div>

            {selectedPatient ? (
              <>
                <ASvg
                  className="first:child:fill-primary-300 min-w-12.5 min-h-12.5"
                  src="avatar"
                />
          ...
          {selectedPatient ? (
            <div className="bg-secondary-20 pl-4 w-full flex flex-col justify-center">
              <p className="text-h4 text-secondary-300">
                {" "}
              ...
              <p className="text-h4 text-secondary-300">
                {" "}
                <span className="font-medium">Health card number: </span>{" "}
                {selectedPatient.hin}{" "}
              </p>
            </div>
          ) : null}
          ...
          <div
            ...
            } fixed z-20 bg-black/50 left-0 h-screen top-0 w-screen`}>
